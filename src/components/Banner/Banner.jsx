...
const Banner = () => {
    return (
        <div className=' px-[10%] pt-[60px] max-w-11/12 mx-auto'>
            <div>
                <h2 className=' text-center font-bold text-[30px] md:text-[72px] text-[#001931]  '>We Build <br /> <span className='bg-[linear-gradient(160deg,#632EE3,#9F62F2)] bg-clip-text text-transparent '>Productive</span> Apps</h2>
            ...
            <div>
                <img src={heroImg} alt="Hero Image" className='mx-auto w-[90%] md:w-[65%] ' />
            </div>
        </div>
    );
};
